@extends('layouts.app')
@section('title',setting('site_title').' - '. $governorate->name)
                  ...
                  <div id="cfilter" class="filter-body">
                     <ul x-data="{url: 'https://directory.smarteyeapps.com' }">
                           @foreach($governorates as $governorate)  
                            ...
                            <input  checked  @click="catFilterClick(url, 'restuarent123', 0, 'list', '')" class="form-check-input" type="radio" name="filtercat" id="filtercat"> {{ $governorate->name }}
                            </a> 
                            </li>
                        @endforeach
