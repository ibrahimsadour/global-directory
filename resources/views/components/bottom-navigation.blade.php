<div class="fixed bottom-0 left-0 z-50 w-full bg-white border-t border-gray-200 dark:bg-gray-700 dark:border-gray-600 md:hidden">
    <div class="grid h-full max-w-lg grid-cols-5 mx-auto">
        ...
        <div id="tooltip-ads" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-xs opacity-0 tooltip dark:bg-gray-700">
            إعلانات
            <div class="tooltip-arrow" data-popper-arrow></div>
        </div>
...
<svg width="35" height="35" viewBox="0 0 19 18" xmlns="http://www.w3.org/2000/svg" data-name="IconAddPost"><path xmlns="http://www.w3.org/2000/svg" fill-rule="evenodd" clip-rule="evenodd" d="M12.5963 4.33333L11.3153 3H7.11533L5.83433 4.33333H3.61533C2.84533 4.33333 2.21533 4.93333 2.21533 5.66667V13.6667C2.21533 14.4 2.84533 15 3.61533 15H14.8153C15.5853 15 16.2153 14.4 16.2153 13.6667V5.66667C16.2153 4.93333 15.5853 4.33333 14.8153 4.33333H12.5963ZM12.7153 9.66667C12.7153 11.5067 11.1473 13 9.21533 13C7.28333 13 5.71533 11.5067 5.71533 9.66667C5.71533 7.82667 7.28333 6.33333 9.21533 6.33333C11.1473 6.33333 12.7153 7.82667 12.7153 9.66667ZM8.91543 9.95237H7.11543V9.38094H8.91543V7.66665H9.51543V9.38094H11.3154V9.95237H9.51543V11.6667H8.91543V9.95237Z" fill="#fff"></path></svg>
        ...
        <div id="tooltip-create" role="tooltip" class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-gray-900 rounded-lg shadow-xs opacity-0 tooltip dark:bg-gray-700">
            انشر إعلان
            <div class="tooltip-arrow" data-popper-arrow></div>
        </div>
